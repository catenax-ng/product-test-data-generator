...
public class CustomInstantDeserializer<T extends Temporal> extends ThreeTenDateTimeDeserializerBase<T> {
	...
	/**
	 * The Class FromDecimalArguments.
	 */
	private static class FromDecimalArguments {
		...
		/**
		 * Instantiates a new from decimal arguments.
		 *
	...
	/**
	 * The Class FromIntegerArguments.
	 */
	private static class FromIntegerArguments {
		...
		/**
		 * Instantiates a new from integer arguments.
		 *
	...
	/** The from milliseconds. */
	protected final Function<FromIntegerArguments, T> fromMilliseconds;

	/** The from nanoseconds. */
	...
	/**
	 * Instantiates a new custom instant deserializer.
	 *
	 * @param supportedType    the supported type
	 * @param parser           the parser
	 * @param parsedToValue    the parsed to value
	 * @param fromMilliseconds the from milliseconds
	 * @param fromNanoseconds  the from nanoseconds
	...
	public T deserialize(JsonParser parser, DeserializationContext context) throws IOException {
		...
		case JsonTokenId.ID_NUMBER_FLOAT: {
			final BigDecimal value = parser.getDecimalValue();
			final long seconds = value.longValue();
			final int nanoseconds = DecimalUtils.extractNanosecondDecimal(value, seconds);
		...
		case JsonTokenId.ID_STRING: {
			...
			T value;
			try {
				final TemporalAccessor acc = _formatter.parse(string);
