    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl: 'https://github.com/catenax-ng/product-test-data-generator/edit/main/',
        },
        blog: {
          showReadingTime: true,
          // Please change this to your repo.
          editUrl:
            'https://github.com/catenax-ng/product-test-data-generator',
        },
        theme: {
    ...
    ({
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/catenax-ng/product-test-data-generator.git',
            label: 'GitHub',
            position: 'right',
          },
        ],
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              ...
              {
                label: 'GitHub',
                href: 'https://github.com/catenax-ng/product-test-data-generator',
              },
            ],
          },
        ],
